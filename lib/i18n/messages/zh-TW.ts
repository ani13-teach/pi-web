...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    // 自動模式設定頁（components/AutomodeConfig.tsx）。
    "common.autoMode": "自動模式",
    "automode.description": "自動判斷操作是否可以執行。",
    "automode.loadFailed": "讀不到自動模式的設定：{error}",
    "automode.status": "現在什麼在跑",
    "automode.builtinVersion": "隨應用程式內建",
    "automode.pluginCopy": "外面那份外掛",
    "automode.pluginInstalled": "{path} 裝著，但沒生效：兩份會跑兩個判斷模型，所以內建這份優先。",
    "automode.pluginAbsent": "沒裝。只有內建這一份。",
    "automode.globalFile": "全域檔案",
    "automode.projectFile": "專案檔案",
    "automode.noProject": "沒開啟專案",
    "automode.untrusted": "信任此專案後，可單獨設定。",
    "automode.nowInForce": "現在真正生效",
    "automode.session": "本工作階段",
    "automode.sessionOn": "跟著設定，開著",
    "automode.sessionOff": "跟著設定，關著",
    "automode.sessionForcedOff": "在工作階段裡被 /automode off 關掉了",
    "automode.sessionForcedOn": "在工作階段裡被 /automode on 打開了",
    "automode.sessionUnknown": "還沒讀到，工作階段可能沒在跑",
    "automode.sessionCounts": "放行 {allowed} 次，攔下 {blocked} 次",
    "automode.sessionClassifierCounts": "其中判定模型：放行 {allowed}，拒絕 {denied}",
    "automode.on": "開",
    "automode.off": "關",
    "automode.noModel": "沒指定模型",
    "automode.scope": "適用範圍",
    "automode.scopeGlobal": "所有專案",
    "automode.scopeProject": "目前專案",
    "automode.scopeGlobalHint": "正在改全域檔案：",
    "automode.scopeProjectHint": "正在改：",
    "automode.blankMeansInherited": "只寫你改過的項，其他值不動。",
    "automode.switch": "開關",
    "automode.enabled": "啟用自動模式",
    "automode.enabledHint": "用於新工作階段；關閉時也停用附帶的權限規則。",
    "automode.models": "用哪個模型判斷",
    "automode.primaryModel": "首選模型",
    "automode.pickModel": "換一個模型",
    "automode.emptyFallback": "不用這條備用模型",
    "automode.modelUnavailable": "「{model}」不在可選清單裡，換一個或保留不動",
    "automode.inheritedModel": "這裡留空，判定就用「{model}」。",
    "automode.fallbackModels": "備用模型，按先後順序試",
    "automode.fallbackModel": "第 {index} 個備用模型",
    "automode.fallbackHint": "首選模型用不了、報錯、逾時、或者裝不下這個動作時，就試下一個。模型明確說不行，那就是最終結果，不再往下試。全部失敗時，動作會被攔住。留空表示不用備用模型。",
    "automode.addFallback": "加一個備用模型",
    "automode.moveUp": "上移",
    "automode.moveDown": "下移",
    "automode.remove": "刪掉",
    "automode.test": "試一下",
    "automode.testing": "正在試…",
    "automode.testOk": "{ms} 毫秒答上了（{text}）",
    "automode.testFailed": "沒通：{error}",
    "automode.budget": "時間和用量",
    "automode.reasoning": "思考檔次",
    "automode.reasoningServer": "讓伺服器自己選",
    "automode.timeout": "一次判斷等多久（毫秒）",
    "automode.timeoutHint": "留空則繼承設定。預設 {value}。",
    "automode.maxTokens": "一次判斷最多回多少 token",
    "automode.maxTokensHint": "留空則繼承設定。預設 {value}。",
    "automode.transcriptUser": "你說的話，最多多少 token",
    "automode.transcriptTool": "工具回傳的內容，最多多少 token",
    "automode.transcriptHint": "留空則繼承設定。預設 {value}。",
    "automode.notAWholeNumber": "{field} 要是大於 0 的整數",
    "automode.behavior": "行為",
    "automode.classifyReadOnly": "唯讀操作也過一遍判斷",
    "automode.allowInside": "專案資料夾裡的操作免檢查",
    "automode.logEnabled": "寫日誌",
    "automode.logIo": "連收發的原文一起寫",
    "automode.behaviorHint": "唯讀操作預設不問直接放行；專案資料夾裡的操作預設還是要過判斷。日誌裡不會有金鑰，但會記下工具輸入。",
    "automode.deniedPaths": "一律攔下的路徑",
    "automode.deniedPathsHint": "一行一個。* 匹配任意字元，包括 /。內建的那批名單一直生效，這裡不顯示。",
    "automode.effective": "現在真正生效的值",
    "automode.effectiveField": "項",
    "automode.effectiveValue": "生效值",
    "automode.effectiveSource": "來自",
    "automode.source.project": "這個專案的檔案",
    "automode.source.global": "全域檔案",
    "automode.source.default": "內建預設",
    "automode.source.merged": "兩個檔案合起來",
    "automode.inherited": "用下層的值",
    "automode.none": "沒有",
    "automode.yes": "是",
    "automode.no": "否",
    "automode.logIoOn": "連收發的原文",
    "automode.ruleCounts": "這裡沒管的部分：{environment} 條環境說明、{allow} 條放行例外、{protectedPaths} 條受保護路徑、{softDeny} 條軟攔規則、{hardDeny} 條硬攔規則、{deny} 條停用規則、{ask} 條要先問一聲的規則。",
    "automode.saving": "正在存…",
    "automode.discard": "放棄這次修改",
    "automode.noSession": "要先開啟一個工作階段才能重載",
    "automode.unsaved": "{count} 處沒存",
    "automode.saved": "已儲存。",
  },
};
