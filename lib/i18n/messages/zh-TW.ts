...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "automode.description": "動作要改動東西之前，自動模式會先讓一個模型判斷一下。下面這些值存在擴充功能自己會讀的那幾個檔案裡，命令列也看得到。",
    ...
    "automode.untrusted": "專案未被信任，這個檔案會被忽略",
    ...
    "automode.scope": "改動存在哪",
    "automode.scopeGlobal": "所有工作階段都用",
    "automode.scopeProject": "只對這個專案",
    "automode.scopeGlobalHint": "正在改全域檔案：",
    "automode.scopeProjectHint": "正在改：",
    "automode.blankMeansInherited": "只寫你改過的項，其他值不動。",
    "automode.switch": "開關",
    "automode.enabled": "預設開著",
    "automode.enabledHint": "這是新工作階段的預設值。只想關掉目前這一個，在輸入框發 /automode off。關掉它，同一個檔案裡那幾條權限規則也一起停。",
    ...
    "automode.timeoutHint": "留空就用下面生效的值。預設 {value}。",
    "automode.maxTokens": "一次判斷最多回多少 token",
    "automode.maxTokensHint": "留空就用下面生效的值。預設 {value}。",
    "automode.transcriptUser": "你說的話，最多多少 token",
    "automode.transcriptTool": "工具回傳的內容，最多多少 token",
    "automode.transcriptHint": "留空就用下面生效的值。預設 {value}。",
