...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    // Auto mode settings page (components/AutomodeConfig.tsx).
    "common.autoMode": "Auto mode",
    "automode.description": "Before it runs an action that changes something, auto mode asks a classifier model to judge it. The settings below are saved to the same files the extension reads, so the command line sees them too.",
    "automode.loadFailed": "Could not read the auto-mode configuration: {error}",
    "automode.status": "What is running",
    "automode.builtinVersion": "Built into this app",
    "automode.pluginCopy": "Plugin copy",
    "automode.pluginInstalled": "{path} is installed but inactive: a second copy would run a second classifier, so the built-in one wins.",
    "automode.pluginAbsent": "Not installed. The built-in copy is the only one.",
    "automode.globalFile": "Global file",
    "automode.projectFile": "Project file",
    "automode.noProject": "No project open",
    "automode.untrusted": "project is not trusted, so this file is ignored",
    "automode.nowInForce": "In force now",
    "automode.session": "This session",
    "automode.sessionOn": "running, as the file says",
    "automode.sessionOff": "off, as the file says",
    "automode.sessionForcedOff": "switched off in this chat with /automode off",
    "automode.sessionForcedOn": "switched on in this chat with /automode on",
    "automode.sessionUnknown": "no report yet (the session may not be running)",
    "automode.sessionCounts": "{allowed} allowed, {blocked} blocked",
    "automode.sessionClassifierCounts": "classifier: {allowed} allowed, {denied} denied",
    "automode.on": "on",
    "automode.off": "off",
    "automode.noModel": "no model chosen",
    "automode.scope": "Where changes are saved",
    "automode.scopeGlobal": "Every session",
    "automode.scopeProject": "This project only",
    "automode.scopeGlobalHint": "Editing the global file:",
    "automode.scopeProjectHint": "Editing:",
    "automode.blankMeansInherited": "Only what you change here is written; the other values stay untouched.",
    "automode.switch": "Switch",
    "automode.enabled": "Auto mode is on by default",
    "automode.enabledHint": "This is the default for new sessions. To switch it off for the current session only, send /automode off in the chat. Switching it off also disables the permission rules that live in the same file.",
    "automode.models": "Which model judges",
    "automode.primaryModel": "Preferred model",
    "automode.fallbackModels": "Fallbacks, tried in this order",
    "automode.fallbackModel": "Fallback {index}",
    "automode.fallbackHint": "A fallback is tried when the preferred model is unavailable, fails, times out, or cannot fit the action. A clear deny is final and blocks either way. When every candidate fails, the action is blocked. An empty list means no fallback.",
    "automode.addFallback": "Add a fallback",
    "automode.moveUp": "Move up",
    "automode.moveDown": "Move down",
    "automode.remove": "Remove",
    "automode.test": "Test",
    "automode.testing": "Testing…",
    "automode.testOk": "Answered in {ms} ms ({text})",
    "automode.testFailed": "Failed: {error}",
    "automode.budget": "Time and token budget",
    "automode.reasoning": "Reasoning effort",
    "automode.reasoningServer": "Let the server choose",
    "automode.timeout": "Timeout per decision (ms)",
    "automode.timeoutHint": "Leave empty to use the inherited value. Default {value}.",
    "automode.maxTokens": "Tokens per decision",
    "automode.maxTokensHint": "Leave empty to use the inherited value. Default {value}.",
    "automode.transcriptUser": "Your messages, in tokens",
    "automode.transcriptTool": "Tool output, in tokens",
    "automode.transcriptHint": "Leave empty to use the inherited value. Default {value}.",
    "automode.notAWholeNumber": "{field} must be a whole number above zero",
    "automode.behavior": "Behaviour",
    "automode.classifyReadOnly": "Check read-only actions too",
    "automode.allowInside": "Skip the check inside the project folder",
    "automode.logEnabled": "Keep a log",
    "automode.logIo": "Log the full requests and replies",
    "automode.behaviorHint": "Read-only actions are allowed without asking by default, and actions inside the project folder are still checked. The log holds no credentials, but it does hold tool input.",
    "automode.deniedPaths": "Paths that are always blocked",
    "automode.deniedPathsHint": "One pattern per line. * matches any characters, including /. The built-in patterns stay in force and are not shown here.",
    "automode.effective": "What is in force",
    "automode.effectiveField": "Setting",
    "automode.effectiveValue": "Value",
    "automode.effectiveSource": "From",
    "automode.source.project": "this project",
    "automode.source.global": "global file",
    "automode.source.default": "built-in default",
    "automode.source.merged": "both files",
    "automode.inherited": "inherited",
    "automode.none": "none",
    "automode.yes": "yes",
    "automode.no": "no",
    "automode.logIoOn": "full requests and replies",
    "automode.ruleCounts": "Untouched here: {environment} environment notes, {allow} allow exceptions, {protectedPaths} protected paths, {softDeny} soft-deny rules, {hardDeny} hard-deny rules, {deny} deny and {ask} ask tool rules.",
    "automode.saving": "Saving…",
    "automode.discard": "Discard changes",
    "automode.noSession": "Open a session to reload it",
    "automode.unsaved": "{count} unsaved",
    "automode.saved": "Saved to {path}.",
  },
};
