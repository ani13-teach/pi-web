...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "automode.description": "Automatically checks whether an action can proceed.",
    ...
    "automode.untrusted": "Trust this project to configure it separately.",
    ...
    "automode.scope": "Apply to",
    "automode.scopeGlobal": "All projects",
    "automode.scopeProject": "Current project",
    ...
    "automode.enabled": "Enable auto mode",
    "automode.enabledHint": "Applies to new sessions. Turning it off also disables its permission rules.",
    "automode.models": "Which model judges",
    "automode.primaryModel": "Preferred model",
    "automode.pickModel": "Change model",
    "automode.emptyFallback": "No model in this row",
    "automode.modelUnavailable": "{model} is not offered any more — pick another or leave it alone",
    "automode.inheritedModel": "Left empty, this uses {model}.",
