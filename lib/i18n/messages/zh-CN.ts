...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "automode.description": "有动作要改动东西之前，自动模式会先让一个模型来判断一下。下面这些值存在扩展自己会读的那几个文件里，命令行也看得到。",
    ...
    "automode.untrusted": "项目没被信任，这个文件会被无视",
    ...
    "automode.scope": "改动存在哪",
    "automode.scopeGlobal": "所有会话都用",
    "automode.scopeProject": "只对这个项目",
    "automode.scopeGlobalHint": "正在改全局文件：",
    "automode.scopeProjectHint": "正在改：",
    "automode.blankMeansInherited": "只写你改过的项，其他值不动。",
    "automode.switch": "开关",
    "automode.enabled": "默认开着",
    "automode.enabledHint": "这是新会话的默认值。只想关掉当前这一次，在输入框发 /automode off。关掉它，同一个文件里那几条权限规则也一起停。",
    ...
    "automode.timeoutHint": "留空就用下面生效的值。默认 {value}。",
    "automode.maxTokens": "一次判定最多回多少 token",
    "automode.maxTokensHint": "留空就用下面生效的值。默认 {value}。",
    "automode.transcriptUser": "你说的话，最多多少 token",
    "automode.transcriptTool": "工具返回的内容，最多多少 token",
    "automode.transcriptHint": "留空就用下面生效的值。默认 {value}。",
