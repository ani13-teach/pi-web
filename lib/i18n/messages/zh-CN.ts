...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    // 自动模式设置页（components/AutomodeConfig.tsx）。
    "common.autoMode": "自动模式",
    "automode.description": "自动判断操作是否可以执行。",
    "automode.loadFailed": "读不到自动模式的配置：{error}",
    "automode.status": "现在什么在跑",
    "automode.builtinVersion": "随应用内置",
    "automode.pluginCopy": "外面那份插件",
    "automode.pluginInstalled": "{path} 装着，但没生效：两份会跑两个判定模型，所以内置这份优先。",
    "automode.pluginAbsent": "没装。只有内置这一份。",
    "automode.globalFile": "全局文件",
    "automode.projectFile": "项目文件",
    "automode.noProject": "没打开项目",
    "automode.untrusted": "信任此项目后，可单独设置。",
    "automode.nowInForce": "现在真正生效",
    "automode.session": "本会话",
    "automode.sessionOn": "跟着设置，开着",
    "automode.sessionOff": "跟着设置，关着",
    "automode.sessionForcedOff": "在聊天里被 /automode off 关掉了",
    "automode.sessionForcedOn": "在聊天里被 /automode on 打开了",
    "automode.sessionUnknown": "还没读到，会话可能没在跑",
    "automode.sessionCounts": "放行 {allowed} 次，拦住 {blocked} 次",
    "automode.sessionClassifierCounts": "其中判定模型：放行 {allowed}，拒绝 {denied}",
    "automode.on": "开",
    "automode.off": "关",
    "automode.noModel": "没指定模型",
    "automode.scope": "适用范围",
    "automode.scopeGlobal": "所有项目",
    "automode.scopeProject": "当前项目",
    "automode.scopeGlobalHint": "正在改全局文件：",
    "automode.scopeProjectHint": "正在改：",
    "automode.blankMeansInherited": "只写你改过的项，其他值不动。",
    "automode.switch": "开关",
    "automode.enabled": "启用自动模式",
    "automode.enabledHint": "用于新会话；关闭时也停用附带的权限规则。",
    "automode.models": "用哪个模型判断",
    "automode.primaryModel": "首选模型",
    "automode.pickModel": "换一个模型",
    "automode.emptyFallback": "不用这条备用模型",
    "automode.modelUnavailable": "「{model}」不在可选列表里，换一个或保留不动",
    "automode.inheritedModel": "这里留空，判定就用「{model}」。",
    "automode.fallbackModels": "备用模型，按先后顺序试",
    "automode.fallbackModel": "第 {index} 个备用模型",
    "automode.fallbackHint": "首选模型用不了、报错、超时、或者装不下这个动作时，就试下一个。模型明确说不行，那就是最终结果，不再往下试。全部失败时，动作被拦住。留空表示不用备用模型。",
    "automode.addFallback": "加一个备用模型",
    "automode.moveUp": "上移",
    "automode.moveDown": "下移",
    "automode.remove": "删掉",
    "automode.test": "试一下",
    "automode.testing": "正在试…",
    "automode.testOk": "{ms} 毫秒答上了（{text}）",
    "automode.testFailed": "没通：{error}",
    "automode.budget": "时间和用量",
    "automode.reasoning": "思考档位",
    "automode.reasoningServer": "让服务器自己选",
    "automode.timeout": "一次判定等多久（毫秒）",
    "automode.timeoutHint": "留空则继承设置。默认 {value}。",
    "automode.maxTokens": "一次判定最多回多少 token",
    "automode.maxTokensHint": "留空则继承设置。默认 {value}。",
    "automode.transcriptUser": "你说的话，最多多少 token",
    "automode.transcriptTool": "工具返回的内容，最多多少 token",
    "automode.transcriptHint": "留空则继承设置。默认 {value}。",
    "automode.notAWholeNumber": "{field} 得是大于 0 的整数",
    "automode.behavior": "行为",
    "automode.classifyReadOnly": "只读操作也过一遍判断",
    "automode.allowInside": "项目文件夹里的操作免检",
    "automode.logEnabled": "记日志",
    "automode.logIo": "连收发的原文一起记",
    "automode.behaviorHint": "只读操作默认不问直接放行；项目文件夹里的操作默认还是要过判断。日志里不会出现密钥，但会记下工具输入。",
    "automode.deniedPaths": "一律拦下的路径",
    "automode.deniedPathsHint": "一行一个。* 匹配任意字符，包括 /。内置的那批名单一直生效，这里不显示。",
    "automode.effective": "现在真正生效的值",
    "automode.effectiveField": "项",
    "automode.effectiveValue": "生效值",
    "automode.effectiveSource": "来自",
    "automode.source.project": "这个项目的文件",
    "automode.source.global": "全局文件",
    "automode.source.default": "内置默认",
    "automode.source.merged": "两个文件合起来",
    "automode.inherited": "用下层的值",
    "automode.none": "没有",
    "automode.yes": "是",
    "automode.no": "否",
    "automode.logIoOn": "连收发的原文",
    "automode.ruleCounts": "这里没管的部分：{environment} 条环境说明、{allow} 条放行例外、{protectedPaths} 条受保护路径、{softDeny} 条软拦规则、{hardDeny} 条硬拦规则、{deny} 条禁用规则、{ask} 条要问一声的规则。",
    "automode.saving": "正在存…",
    "automode.discard": "放弃这次修改",
    "automode.noSession": "要先打开一个会话才能重载",
    "automode.unsaved": "{count} 处没存",
    "automode.saved": "已保存。",
  },
};
