      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            {/* Own label on purpose: this reloads the whole window rather than the session list, and
                upstream's source-shape test forbids the sidebar.refresh label on a button here. */}
            <button
              type="button"
              onClick={() => window.location.reload()}
              title={t("sidebar.reloadWindow")}
              aria-label={t("sidebar.reloadWindow")}
