...
export { __resetState, getNextId, getTodos, sid } from "./state/store.js";
...
export function registerTodoTool(pi: ExtensionAPI, readState: () => TaskState): void {
	...
	pi.registerTool({
		...
		// ToolRenderContext has no session identity. Bind this ctx-less render hook
		// to the owning extension factory's session instead of a global pointer.
